...
export default class SecondColumn extends Component { state = {
  toggleNav: false,
  viewAccounts: false,
  ...
  analysis: [
    ...
    render() {
        return (
        <div className={
          this.props.maxSize_2 ? "column main" : 
          (this.props.maxSize_1 || this.props.maxSize_3) ? "column min" : "column"}>
          <header><span>Build</span><img src={settingsIcon} alt="setting icon"
          onClick={() => this.setState({settingToggleBuild: !this.state.settingToggleBuild})}/></header>
          <span className={this.state.settingToggleBuild ? "settingsTag edit" : "settingsTag"}></span>
            <div className={this.state.settingToggleBuild ? "settings edit" : "settings"}>
              <div className="settingsOption">
                <p
                    onClick={()=> this.setState({buildAutoRefresh: !this.state.buildAutoRefresh})}
                >Auto reload <span
                  className={this.state.buildAutoRefresh? "active" : " "}
                  style={this.state.buildAutoRefresh?{backgroundColor: "rgb(38, 41, 49)",}:{backgroundColor: "whitesmoke",}}
                ></span></p>
              </div>
              <div className="settingsOption">
          ...
          <div className="build">
          <span className="title"><h3>AVERAGE BUILD DURATION</h3><h3>TOTAL BUILD</h3></span>
